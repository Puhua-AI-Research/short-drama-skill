...
普华开放平台提供完整的 API 接口文档（OpenAI 兼容 Base URL、文本 / 图像 / 视频生成示例等），请访问官方文档查看：

**官方文档地址：** [https://ph8.co/docs](https://ph8.co/docs)

文档包含：
- 统一 API 接口说明（兼容 OpenAI 格式）
- 文本生成（LLM）、图像生成、视频生成完整示例
- 参数配置与最佳实践
- 错误处理与常见问题

本仓库的 `scripts/ph8_*.py` 脚本已封装常用功能，面向 **自动化调用**；官方文档面向 **人工查阅与扩展参数**。
